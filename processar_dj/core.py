        ...
        con.execute(
            f"""INSERT INTO {TABELA_PROCESSOS}
                (processo, status, conta, conta_judicial, processo_judicial,
                 ...
                 caminho_comprovante_djo, caminho_gr, num_doc, cnpj, data_alvara,
                 tem_gr, tem_comprovante, tem_comprovante_djo, tem_despacho_apos_gr,
                 usuario_resposta, data_hora_resposta, tempo_resposta)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)""",
            (processo, status, conta, conta_judicial, processo_judicial,
             data_pagamento, ano, valor_pesquisa, caminho_comprovante,
             caminho_comprovante_djo, caminho_gr, num_doc, cnpj, data_alvara,
             tem_gr or 0, tem_comprovante or 0, tem_comprovante_djo or 0, tem_despacho_apos_gr or 0,
             usuario_resposta, data_hora_resposta, tempo_resposta),
        )
        con.commit()
